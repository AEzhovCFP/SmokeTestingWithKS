...
WebUI.scrollToElement(findTestObject('Billing/pge_PolicyTermSummary/lbl_billingFrequency'), GlobalVariable.gTimeOutSeconds)

WebUI.verifyElementText(findTestObject('Billing/pge_PolicyTermSummary/lbl_billingFrequency'), billingFrequency)
WebUI.println("\tBilling Frequency:\t"+ billingFrequency)
