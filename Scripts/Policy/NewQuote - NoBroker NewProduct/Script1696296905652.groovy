...
/*def brokername = WebUI.getAttribute(findTestObject('Policy/pge_NewQuote/lbl_BrokerName'), 'value')

if (brokername == GlobalVariable.gBrokerUsername) {
    WebUI.comment('\tNew quote using broker login...')
}
*/
...
CustomKeywords.'common.Text.TypeTextAndTab'(findTestObject('Policy/pge_NewQuote/txt_Product'), Product_New)
