...
CustomKeywords.'common.Actions.Click'(findTestObject('Policy/pge_Pricing/btn_Approve'))

WebUI.waitForPageLoad(GlobalVariable.gTimeOutSeconds)

WebUI.setText(findTestObject('Policy/pge_Pricing/txt_Remark_Approve'), Remarks)
