...
CustomKeywords.'common.Text.TypeTextAndTab'(findTestObject('Policy/pge_NewQuote/drp_brokerage'), GlobalVariable.gBrokerage)

CustomKeywords.'common.Text.TypeTextAndTab'(findTestObject('Policy/pge_NewQuote/drp_BrokerName'), GlobalVariable.gBrokerName1)*/
...
CustomKeywords.'common.Text.TypeTextAndTab'(findTestObject('Policy/pge_NewQuote/txt_Product'), Product)
