...
GlobalVariable.gPolicyNumber = WebUI.getAttribute(findTestObject('Policy/pge_Transact/lbl_PolicyNumber'),'textContent')

System.out.println("Policy issued is:"+ GlobalVariable.gPolicyNumber)

WebUI.waitForPageLoad(GlobalVariable.gTimeOutSeconds)

WebUI.closeBrowser()

WebUI.callTestCase(findTestCase('Policy/Login/InternalUserLogin - Without Brokerage'),null)

WebUI.waitForPageLoad(GlobalVariable.gTimeOutSeconds)

CustomKeywords.'common.Text.TypeTextAndEnter'(findTestObject('Policy/PolicySearch/txt_PolicySearch'), GlobalVariable.gPolicyNumber)
