...
CustomKeywords.'common.Actions.Click'(findTestObject('Policy/pge_Pricing/chk_IAcknowledge'))

WebUI.verifyElementPresent(findTestObject('Policy/pge_Pricing/txt_BrokerName'), GlobalVariable.gTimeOutSeconds)

CustomKeywords.'common.Text.TypeTextAndEnter'(findTestObject('Policy/pge_Pricing/txt_BrokerName'), GlobalVariable.gBrokerName)
