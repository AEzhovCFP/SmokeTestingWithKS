...
WebUI.click(findTestObject('Claims/pge_LossDetails/btn_Continue'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Claims/pge_Common/btn_SaveAndContinue'), FailureHandling.STOP_ON_FAILURE)

Thread.sleep(3000)

WebUI.click(findTestObject('Claims/pge_LossDetails/btn_Cancel'), FailureHandling.OPTIONAL)
